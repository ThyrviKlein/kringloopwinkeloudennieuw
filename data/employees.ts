...
export const employees: Employee[] = [
  ...
  },
  {
    ...
    role: "Vrijwilliger",
    description:
      "Ronald noemt zichzelf geen 'vaste vrijwilliger', maar als je dagelijks meerdere keren in de winkel aanwezig bent, dan ben je het stiekem toch 😉. Ronald zorgt ervoor dat het koffie apparaat dagelijks wordt onderhouden; schoongemaakt en bijgevuld. Koffiekopjes worden afgewassen en de koektrommel gevuld. Maar Ronald is niet alleen de man van de koffie. Ronald is tevens de beste vriend en mentor van Jan Willem. En daarnaast de grootste lolbroek die in de winkel rondloopt. Er gaat geen dag voorbij dat Ronald je niet aan het lachen kan maken met een leuke grap of mop en door zijn aanstekelijke lach vrolijkt hij iedereen op.",
  },
  {
    name: "Kim",
    image: "",
