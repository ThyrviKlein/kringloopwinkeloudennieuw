...
// Function to update header content and set active navigation
    ...
    <div class="header-container">
      ...
      <nav class="main-nav">
        <ul>
          ...
          <li><a href="about.html" class="${currentPage === 'about.html' ? 'active' : ''}">Over Ons</a></li>
          <li><a href="vintage-corner.html" class="${currentPage === 'vintage-corner.html' ? 'active' : ''}">Vintage Corner</a></li>
        </ul>
      </nav>
    </div>
  `;
